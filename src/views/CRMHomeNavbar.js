    ...
    render() {
        return <div>
            ...
            <Navbar dark color="dark" expand="md">
                <NavbarBrand href={`/home/${this.props.match.params.area}`}>{this.props.zoneName}</NavbarBrand>
                <NavbarToggler onClick={this.toggle} />
                <Collapse isOpen={this.state.isOpen} navbar>
                    <Nav className="ml-auto" navbar>
                        <NavItem>
                            <NavLink active href={`/home/${this.props.match.params.area}`}>Home</NavLink>
                        </NavItem>
                        <NavItem>
                            <NavLink active href={`/home/${this.props.match.params.area}/search`}>Search</NavLink>
                        </NavItem>
                        <NavItem>
                            <NavLink active href="/home">Select Area</NavLink>
                        </NavItem>
